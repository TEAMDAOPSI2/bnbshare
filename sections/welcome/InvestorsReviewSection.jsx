      ...
      <div className="container px-3 py-12 mx-auto">
        <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 ">
          <div className="flex flex-col justify-center max-w-[80%] sm:max-w-[100%] mx-auto">
            <h2 className="sm:text-5xl text-3xl sm:text-left text-center leading-[1.2] pb-2 font-bold md:w-[80%]">
              {t('dont_just_take_our_word')}
            </h2>
            <h2 className="sm:text-5xl text-3xl sm:text-left text-center leading-[1.2] font-bold md:w-[80%]">
              {t('see_what_our_investors')}
            </h2>
          </div>
